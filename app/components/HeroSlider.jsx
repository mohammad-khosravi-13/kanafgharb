...
export default function Hero() {
  return (
    <section
      ...
      className="relative isolate flex min-h-dvh w-full max-w-full items-center justify-center overflow-hidden bg-[#080d18] pt-20 md:pt-20"
    >
      {/* =========================================================
          BACKGROUND
      ========================================================= */}
      ...
      >
        <div className="absolute -inset-[25%] animate-pulse bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.08)_0%,transparent_65%)]" />

        <div className="absolute left-[20%] top-[35%] h-32 w-32 -translate-x-1/2 -translate-y-1/2 animate-[float_6s_ease-in-out_infinite] rounded-full bg-blue-400/5 blur-3xl" />

        <div className="absolute bottom-[25%] right-[25%] h-40 w-40 translate-x-1/2 translate-y-1/2 animate-[float_8s_ease-in-out_infinite_reverse] rounded-full bg-indigo-400/5 blur-3xl" />
      </div>
      ...
      <motion.div
        ...
        className="absolute left-4 top-24 z-20 flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-[10px] font-medium text-white/60 backdrop-blur-md sm:left-6 sm:px-4 sm:py-2 sm:text-xs"
      >
      ...
      {/* =========================================================
          MAIN CONTENT
      ========================================================= */}
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center justify-center px-4 py-12 text-center sm:px-6 md:py-16 lg:py-20">
        {/* =====================================================
            H1
        ===================================================== */}
        <motion.h1
        ...
        <motion.div
          ...
          aria-hidden="true"
          className="relative mx-auto mt-5 h-[3px] max-w-[80px] rounded-full bg-gradient-to-r from-blue-400 to-indigo-400 shadow-[0_0_12px_#3b82f6]"
        >
        ...
        <motion.p
          ...
          className="mx-auto mt-6 w-full max-w-2xl text-xs leading-7 text-white/70 sm:text-sm md:text-base lg:text-lg lg:leading-8"
          style={{
      ...
      <motion.a
        ...
        className="absolute bottom-5 left-1/2 z-20 -translate-x-1/2 text-white/30 transition-colors hover:text-white/60 sm:bottom-6"
      >
        <motion.div
          animate={{
            y: [0, 8, 0],
